                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-5">
                                <div class="mb-2 mb-lg-0">
                                    <h3 class="mb-0  text-white">View All Events</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="card p-5">
                            ...
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4 class="mb-0">All type of Events</h4>
                                    ...
                                    <table class="table text-nowrap mb-0 table-centered table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="p-1 border"><a onClick="javascript: return confirm('Are you Sure Want To Delete');" href="AdminBack.php?action=DeleteEvent&key=<?php echo $data['Keycode'];?>" ><i class=" fas fa-trash"></i></a></span>
                                                    <span class="p-1 border"><a href="edit_bird.php?key=<?php echo $data['Keycode']; ?>"><i class="fas fa-edit"></i></a></span>
                                                </td>
                                            </tr>                                            
                                        </tbody>
                                        <?php
