...
<!-- Mirrored from dashui.codescandy.com/dashuipro/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Jun 2023 10:50:46 GMT -->
...
<head>
    ...
    <title>Alva's | Jain Temple</title>
</head>
                ...
                <div class="container-fluid mt-n22 ">
                    ...
                    mb-3">
                      ...
                      rounded-2">
                                    ...
                                    <div class="lh-1">
                                    <?php
                                            $query=mysqli_query($conn,"SELECT COUNT(*) AS tot_event FROM tbl_events");
                                            $result = mysqli_fetch_assoc($query);                                                                          
                                        ?> 
                                        <h1 class="  mb-1 fw-bold"><?php echo $result['tot_event']; ?></h1>
                    ...
                    mb-3">
                      ...
                      rounded-2">
                                    ...
                                    <div class="lh-1">
                                    <?php
                                            $query=mysqli_query($conn,"SELECT COUNT(*) AS tot_blog FROM tbl_blog");
                                            $result = mysqli_fetch_assoc($query);                                                                          
                                        ?> 
                                        <h1 class="  mb-1 fw-bold"><?php echo $result['tot_blog']; ?></h1>
                                        <!-- <p class="mb-0"><span class="text-success me-2">5</span>Completed</p> -->
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-12 mb-5 mb-xl-0">
                            <div class="card h-100">
                                ...
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h4 class="mb-0">Recently Added Festivals </h4>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive table-card">
                                        ...
                                        <?php
                                        $query="SELECT * from tbl_events LIMIT 5";
                                        $result = mysqli_query($conn,$query);
                                        $a=0;
                                        while($data = mysqli_fetch_array($result))
                                        {                               
...
<!-- Mirrored from dashui.codescandy.com/dashuipro/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Jun 2023 10:51:38 GMT -->
