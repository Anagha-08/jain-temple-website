        ...
        <div id="app-content">
            ...
            <div class="app-content-area">
                ...
                <div class="container-fluid mt-n22 ">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-5">
                                <div class="mb-2 mb-lg-0">
                                    <h3 class="mb-0  text-white">Add Festivals</h3>
                                </div>
                    ...
                    <div class="row">
                        <div class="card p-5">
                            <form method="POST" action="AdminBack.php?action=add_event" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="textInput">Event Name</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="textInput">Event Description</label>
                                            <textarea id="Description" class="form-control"
                                                placeholder="Event Description" name="Description"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-3">
